...
\begin{enumerate}[1.]
	...
	\begin{center}
	\includegraphics[width=5cm]{./Imagenes/actividad_05_01a}
	...
	\begin{center}
	\includegraphics[width=5cm]{./Imagenes/actividad_05_02a}
	...
	\begin{center}
	\includegraphics[width=5cm]{./Imagenes/actividad_05_03a}
	...
	\\where last\_name like 'A\%'
     	\\ or last\_name like 'J\%'
      	...
      	\begin{center}
	\includegraphics[width=5cm]{./Imagenes/actividad_05_04a}
	...
	\begin{center}
	\includegraphics[width=5cm]{./Imagenes/actividad_05_05a}
	...
	\begin{center}
	\includegraphics[width=5cm]{./Imagenes/actividad_05_06a}
	\includegraphics[width=5cm]{./Imagenes/actividad_05_06}
	\end{center}
	...
	\\FROM employees;
	\begin{center}
		\includegraphics[width=5cm]{./Imagenes/actividad_05_07a}
	...
	\begin{center}
		\includegraphics[width=5cm]{./Imagenes/actividad_05_08}
	\end{center}
\end{enumerate}
